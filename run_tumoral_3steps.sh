...
# nohup bash run_tumoral_3steps_mem2.sh > output/20241008_dev09_tumoral_mem2/run.log 2>&1 &
...
output_dir="/data/lush-dev/shijiashuai/workspace/dev/ctDNA/test/output/20241008_dev09_tumoral_mem2"
...
align_genome() {
    run_command "step3_first_align" bash -c "
        ...
        ${tools[bwa-mem2]} mem -p -t $bwa_threads $hg38_mem2 /dev/stdin |
