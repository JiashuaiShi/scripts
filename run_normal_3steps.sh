...
# nohup bash run_normal_3steps_mem2.sh > output/20241008_dev09_normal_mem2/run.log 2>&1 &
...
output_dir="/data/lush-dev/shijiashuai/workspace/dev/ctDNA/test/output/20241008_dev09_normal_mem2"
log_dir="$output_dir/logs"
log_file="$log_dir/pipeline_$timestamp.log"

# Sample and file information
sample="normal_01"
R1="/data/lush-dev/yinlonghui/ctDNA/E150035817_L01_1201_1.fq.gz"
R2="/data/lush-dev/yinlonghui/ctDNA/E150035817_L01_1201_2.fq.gz"
pl_unit="barcode_001"
pl="MGI"
...
align_genome() {
    run_command "step3_first_align" bash -c "
        ...
        ${tools[bwa-mem2]} mem -p -t $bwa_threads $hg38 /dev/stdin |
