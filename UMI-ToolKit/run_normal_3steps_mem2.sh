...
# nohup bash run_normal_3steps.sh > output/20241008_dev09_normal/run.log 2>&1 &
...
output_dir="/data/lush-dev/shijiashuai/workspace/dev/ctDNA/test/output/20241008_dev09_normal"
